...
Gem::Specification.new do |s|
  ...
  s.has_rdoc = true
  s.homepage = %q{http://github.com/newellista/roart}
  s.rdoc_options = ["--main", "README.rdoc"]
  s.require_paths = ["lib"]
  s.rubyforge_project = %q{roart}
  s.rubygems_version = %q{1.3.2}
  s.summary = %q{Interface for working with Request Tracker (RT) tickets inspired by ActiveRecord with minor modifications}
