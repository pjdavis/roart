...
== DESCRIPTION:
  If you are using Best Practical's Request Tracker (RT) and you 
  need to interact with tickets from other applications, Roart provides
  an interface that is slightly reminiscent of ActiveRecord. 
...
== FEATURES/PROBLEMS:
  ...
  *This has only been tested against RT 3.6. Changes to the REST interface in later versions
  of RT may break stuff. 
